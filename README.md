...
1. [Getting Started](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#getting-started)

2. [Getting Software](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#getting-software)

3. [Gaming](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#gaming)

4. [Game Development](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#game-development)

5. [Setting up a macOS workspace](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#setting-up-a-macos-workspace)

6. [Setting up a Windows 10 workspace](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#setting-up-a-windows-10-workspace)

7. [Using Android and Android Apps on Linux](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#using-android-and-android-apps-on-linux)

8. [Professional Audio/Video Editing](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#professional-audio--video-editing)

9. [Kubernetes](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#kubernetes)

10. [Machine Learning](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#machine-learning)

11. [Robotics](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#robotics)

12. [Open Source Security](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#open-source-security)

13. [Differential Privacy](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#differential-privacy)

14. [Cloud Native Development](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#cloud-native-development)

15. [DevOps Development](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#devops-development)

16. [Flutter Development](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#flutter-development)

17. [Networking](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#networking)

18. [Databases](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#databases)

19. [GNOME Extensions](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#gnome-extensions)

20. [Advanced Topics](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#advanced-topics)


# Getting Started

[Rocky Linux](https://rockylinux.org/) is a community enterprise operating system designed to be 100% bug-for-bug compatible and forked from Red Hat Enterprise Linux(RHEL) now that its [downstream partner(Red Hat) has shifted direction](https://blog.centos.org/2020/12/future-is-centos-stream/). It is under intensive development by the open source community. Rocky Linux is led by [Gregory Kurtzer](https://github.com/gmkurtzer), founder of the CentOS project.

[How to Migrate to Rocky Linux from CentOS, Alma Linux, RHEL, or Oracle Linux](https://docs.rockylinux.org/zh_CN/guides/migrate2rocky/)
...
[Rocky Linux GitLab](https://git.rockylinux.org/rocky)

[Rocky Linux Discusion on Mattermost](https://chat.rockylinux.org/)
...
[Back to the Top](https://github.com/mikeroyal/Rocky-Linux-Guide/blob/main/README.md#table-of-contents)
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Rocky-Linux-Guide/pulls).
